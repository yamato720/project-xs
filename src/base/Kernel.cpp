...
void Kernel::stop_snapshot_capture(std::string capture_name) {
...
void Kernel::begin_snapshot_capture_segment(SnapshotCaptureContext& context) {
...
void Kernel::finish_snapshot_capture_segment(SnapshotCaptureContext& context) {
