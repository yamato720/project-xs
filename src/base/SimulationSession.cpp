...
void SimulationSession::stop_snapshot_capture(std::string capture_name) {
...
void SimulationSession::begin_snapshot_capture_segment(SnapshotCaptureContext& context) {
...
void SimulationSession::finish_snapshot_capture_segment(SnapshotCaptureContext& context) {
